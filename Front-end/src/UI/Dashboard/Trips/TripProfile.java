...
public class TripProfile {
    ...
    private Label tripId = new Label();
    ...
    public void setTripId(String recordedEmployee) {
        this.tripId.setText(recordedEmployee);
    }
    ...
    public AnchorPane createTripProfile() {
        ...
        tripId.setLayoutX(30.0); tripId.setLayoutY(142.0); tripId.prefHeight(30.0); tripId.prefWidth(246.0); tripId.setStyle("-fx-text-fill: #73879C; -fx-font-weight: bold;");
        ...
        anchor.getChildren().addAll(locoNumber, date, time, tripDetails, tripId, driverId);
